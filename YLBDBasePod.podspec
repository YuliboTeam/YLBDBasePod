...
Pod::Spec.new do |s|
  s.name             = 'YLBDBasePod'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YLBDBasePod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/余礼钵/YLBDBasePod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '余礼钵' => '564885081@qq.com' }
  s.source           = { :git => 'https://github.com/余礼钵/YLBDBasePod.git', :tag => s.version.to_s }
